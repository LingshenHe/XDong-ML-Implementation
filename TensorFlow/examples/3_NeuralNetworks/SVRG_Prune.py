...
# retraining........
def get_th(wd1_out1, wd1_out2, pp=0.9):
...
#            print('start preparation', time.time())
            ...
            new_w=get_th(sess.run(weights_layer2_inner['w']),sess.run(weights_layer2_inner['b']))
...
#                                                 layer2_label: layer2_label_train})
    ...
    sess.run(weights_trained['fc2'].assign(new_w[0])) 
    sess.run(biases_trained['fc2'].assign(new_w[1])) 
